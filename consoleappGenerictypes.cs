...
namespace ConsoleApp78
{
    class Program
    {
        ...
        {
            Shop GrindersCafe = new Shop();

            ChooseFromMenu(GrindersCafe);

        }

        static void ChooseFromMenu(Shop shop)
        {
            Console.WriteLine("1.Zehmet olmazsa Icki elave edin");
            Console.WriteLine("2. Zehmet olmazsa Icki satisi edin");
            Console.WriteLine("3. kassani gorun");
            Console.WriteLine("4. Mehsullari gorun");
        ...
        type:
            Console.Write("ickinizin Tipini daxil edin: ");
